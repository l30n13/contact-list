...
public class AddNewContactActivity extends Activity {
    ...
    public void show(View view) {
        for (i = 0; i < allEds.size(); i++) {
            if (i == 0) {
                contactHelper.setPhone2(allEds.get(0).getText().toString());
                contactHelper.setPhoneType2(allPhoneSp.get(0).getSelectedItem().toString());
            } else if (i == 1) {
                contactHelper.setPhone3(allEds.get(1).getText().toString());
                contactHelper.setPhoneType2(allPhoneSp.get(1).getSelectedItem().toString());
            } else if (i == 2) {
                contactHelper.setPhone4(allEds.get(2).getText().toString());
                contactHelper.setPhoneType2(allPhoneSp.get(2).getSelectedItem().toString());
            } else if (i == 3) {
                contactHelper.setPhone5(allEds.get(3).getText().toString());
                contactHelper.setPhoneType2(allPhoneSp.get(3).getSelectedItem().toString());
            }
        }
